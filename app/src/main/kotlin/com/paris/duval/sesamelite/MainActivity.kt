...
import com.paris.duval.sesamelite.crypto.KeyAvailabilityMonitor
...
import com.paris.duval.sesamelite.ui.nav.SesameNavGraph
import com.paris.duval.sesamelite.ui.onboarding.OnboardingScreen
import com.paris.duval.sesamelite.ui.theme.SesameLiteTheme
...
class MainActivity : ComponentActivity() {
    ...
    private fun handleIncomingIntent(intent: Intent?) {
        ...
        if (intent.action == Intent.ACTION_VIEW) {
            ...
            val isCustomScheme = data.scheme == "sesame" && data.host == "import"
            val isAppLink = data.scheme == "https" &&
                data.host == "sesame-app.com" &&
